---
title: "Influence of menstruation on Dutch female blood donors part 3"
author: "Sofie Ekroos"
date: "5.5.2022"
output:
  html_document:
...
```{r}
file <- "~/folder/logistic_mens_pbac"
...
regressor_values <- c(
    ...
    "years_since_menarche" = "Years since menarche",
    ...
    "DaysBetweenCycles" = "Days between two cycles",
    "BleedingDays" = "Number of days bleeding"
)
```
...
```{r}
file <- "~/folder/logistic_mens_pbac_int"
...
```{r}
file <- "~/folder/logistic_mens_control"
...
```{r}
file <- "~/folder/logistic_anemia_mens_pbac"
...
```{r}
file <- "~/folder/logistic_anemia_mens_pbac_int"
...
```{r}
file <- "~/folder/logistic_anemia_mens"
...
```{r}
file <- "~/folder/logistic_anemia_mens_control"
...
```{r}
file <- "~/folder/logistic_125_mens_pbac"
...
```{r}
file <- "~/folder/logistic_125_mens_pbac_int"
...
```{r}
file <- "~/folder/logistic_125_mens_control"
